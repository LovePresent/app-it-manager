  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'purchased-devices', name: 'PurchasedDevices', component: () => import('@/views/DeviceListReportView.vue'), meta: { reportMode: 'purchase' } },
        { path: 'distributed-devices', name: 'DistributedDevices', component: () => import('@/views/DeviceListReportView.vue'), meta: { reportMode: 'distribution' } },
        { path: 'device-licenses', name: 'DeviceLicenses', component: () => import('@/views/DeviceLicensesView.vue') },
        { path: 'computer-settings', name: 'ComputerSettings', component: () => import('@/views/ComputerSettingsView.vue') },
        ...
        { path: 'ai-subscriptions', name: 'AIUsageSubscriptions', component: () => import('@/views/AIUsageSubscriptionsView.vue') },
